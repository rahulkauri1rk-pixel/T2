                ...
                {error && (
                    <div className="mb-8 p-6 bg-rose-50 border border-rose-100 rounded-3xl animate-fade-in">
                        ...
                        <div className="flex flex-col gap-2">
                            <button onClick={() => window.open('https://console.firebase.google.com/')} className="text-[10px] font-black text-rose-500 uppercase tracking-widest hover:underline flex items-center gap-1.5"><ExternalLink size={12} /> Open Firebase Rules Console</button>
